    ...
    return (<div style={{
      ...
      <Paper elevation={20} style={{
        ...
        <div className='slider'>
          <Slider min={1} max={4} step={0.01} value={scale} onChange={this.handleSliderChange}/>
          <TextField id="x" label="x" value={this.state.moveX} onChange={this.handleChange('moveX')} type="number" InputLabelProps={{
              shrink: true
            }} margin="normal"/>
          <TextField id="y" label="y" value={this.state.moveY} onChange={this.handleChange('moveY')} type="number" InputLabelProps={{
              shrink: true
            }} margin="normal"/>
          <TextField id="scale" label="scale" value={this.state.scaleTo} onChange={this.handleChange('scaleTo')} type="number" InputLabelProps={{
              shrink: true
            }} margin="normal"/>
      ...
      <div className='interactive' style={{
        ...
        <div className='overlayLayer' style={{
          ...
          <OverlayElement x={30} y={50} unscalable="unscalable">
            <Button variant="fab" color="primary" aria-label="add">
              <AddIcon/>
            </Button>
          </OverlayElement>
          <OverlayElement x={70} y={20} unscalable="unscalable">
            <Button variant="fab" color="primary" aria-label="add">
              <AddIcon/>
            </Button>
          </OverlayElement>
        </div>
        <div className='mapImage' style={{
            zIndex: 0
          }}>
